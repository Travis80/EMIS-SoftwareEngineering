...
for ( $day = 1; $day <= $day_count; $day++, $str++){
    ...
    if($today == $date){
        ...
        $week .='<td class="appointment"><a href="javascript:void(0)" onclick="toggle_visibility();">'.$day;
        $sql = "SELECT * FROM Appointment WHERE id=$counter";
        $result= $conn->query($sql);
    ...
    <div id="popup" class="position">
        <div id="wrapper">
            <div id="popup-container">
                ...
                <form >
                <section name="first">First Name: </section><input type="text" name="first" value="<?php echo $row["first"]; ?>" readonly><br><br>
                <section name="last">Last Name: </section><input type="text" name="last" value="<?php echo $row["last"]; ?>" readonly><br><br>
                <section name="time">Time: </section><input type="text" name="time" value="<?php echo $row["time"]; ?>" readonly><br><br>
                <section name="description">Reason for Visit: </section><textarea name="description" readonly><?php echo $row["description"]; ?></textarea><br>
                </form>   
            </div>
        </div>
    </div>
